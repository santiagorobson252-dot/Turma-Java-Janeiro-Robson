...
public class Principal {
	...
	public static void main(String[] args) {
		...
		if (opcao.equals("B")) {
			...
			jogadorBasquete.setIdadeAtleta(entradaDeDados.nextInt());
			...
			System.out.println("A Braço mais forte: " + jogadorBasquete.getBracoMaisForte());
		...
		if (opcao.equals("F")) {
			...
			jogadorFutsal.setIdadeAtleta(entradaDeDados.nextInt());
